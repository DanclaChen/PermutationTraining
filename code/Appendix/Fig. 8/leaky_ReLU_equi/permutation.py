...
#     device = torch.device("mps" if torch.backends.mps.is_available() else "cpu")
    ...
    torch.save(model.state_dict(), './trained_model/leaky-Sin-'+str(params.times_n)+'Xweight-bs'+str(params.batch_size)+'-k'+str(params.k_period)+'-adjust'+str(params.adjust_scale)+'-W'+str(params.width)+'-iter'+str(j)+'.pth')
