...
def weights_init_3D(shape, times_w):
    # initial the weights in the first layer as [1, 1, ..., 1, -1, -1, ..., -1]

    # get the half of the shape
    shape_np = np.array(shape)
    shape_half = np.ceil(np.divide(shape_np, times_w)).tolist()

    
    W_1 = 1.7321 * torch.ones(int(shape_half[0]))
    W_2 = -1 * W_1
    W_0 = torch.zeros(int(shape_half[0]))
    

    W = torch.stack([torch.cat([W_1, W_0, W_0, W_2, W_0, W_0, W_1, W_1, W_0, W_2, W_2, W_0, W_1, W_1, W_0, W_2, W_2, W_0, W_1, W_2, 
                                W_1, W_1, W_2, W_2, W_2, W_1
                                ]), 
                     torch.cat([W_0, W_1, W_0, W_0, W_2, W_0, W_1, W_0, W_1, W_2, W_0, W_2, W_2, W_0, W_1, W_1, W_0, W_2, W_1, W_2, 
                                W_1, W_2, W_1, W_2, W_1, W_2
                                ]),
                     torch.cat([W_0, W_0, W_1, W_0, W_0, W_2, W_0, W_1, W_1, W_0, W_2, W_2, W_0, W_2, W_2, W_0, W_1, W_1, W_1, W_2, 
                                W_2, W_1, W_1, W_1, W_2, W_2 
                                ])
                     ], dim=1)
